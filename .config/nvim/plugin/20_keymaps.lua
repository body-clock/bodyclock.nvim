...
-- mini.pick pickers
nmap('<leader>sf', function() require('mini.pick').builtin.files() end,       'Find file')
nmap('<leader>sg', function() require('mini.pick').builtin.grep_live() end,   'Find string live')
nmap('<leader>sw', function()
  require('mini.pick').builtin.grep({ pattern = vim.fn.expand('<cword>') })
end, 'Find word under cursor')
nmap('<leader>ls', function() require('mini.pick').builtin.buffers() end,     'Find buffer')
nmap('<leader>sh', function() require('mini.pick').builtin.help() end,        'Find help tags')
nmap('<leader>sm', function() require('mini.extra').pickers.marks() end,      'Find marks')
...
nmap('<leader>sr', function() require('mini.pick').builtin.resume() end, 'Resume last picker')
...
nmap('<leader>po', function() require('peek').open() end,  'Open markdown preview')
nmap('<leader>pc', function() require('peek').close() end, 'Close markdown preview')

-- View component (local dev plugin)
nmap('<leader>vc', function() require('view-component').switch() end, 'Switch view component')
